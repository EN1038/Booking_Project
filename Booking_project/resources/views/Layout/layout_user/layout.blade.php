...
<body>
    ...
    <div id="mySidenav" class="sidenav">
        <div class="d-flex flex-column text-white p-3 costome-hight">
          ...
          <a href="{{route('dashboard_user')}}" class="text-decoration-none">
          ...
          <a href="{{ route('statusRoom', Auth::user()->id) }}" class="text-decoration-none">
            <div class="hover-btn d-flex flex-row mb-1 rounded-3  align-items-center">
              <div class="col-2 fs-4 text-center">
                <i class="fa-solid fa-square-check"></i>
              </div>
              <div class="col d-flex align-items-center justify-content-center fs-7">
                <span class="divToHide ">เช็คสถานะการจอง</span>
              </div>
            </div>
          </a>
          @endif
          @if(Auth::user()->status_user == 'จองไม่ได้')
          <a href="{{ route('error_user', Auth::user()->id) }}" class="text-decoration-none">
            <div class="hover-btn d-flex flex-row mb-1 rounded-3  align-items-center">
              <div class="col-2 fs-4 text-center">
                <i class="fa-solid fa-triangle-exclamation"></i>
              </div>
              <div class="col d-flex align-items-center justify-content-center fs-7">
                <span class="divToHide ">สถานะตัวผู้ใช้</span>
              </div>
            </div>
          </a>
          @endif
          <a href="{{route('history', Auth::user()->id)}}" class="text-decoration-none">
            <div class="hover-btn d-flex flex-row mb-1 rounded-3  align-items-center">
              <div class="col-2 fs-4 text-center">
                <i class="fa-solid fa-clipboard"></i>
              </div>
              <div class="col d-flex align-items-center justify-content-center fs-7">
                <span class="divToHide ">ประวัติการจอง</span>
              </div>
            </div>
          </a>
        </div>
            ...
            <div class="col ">
                <div class=" d-none d-sm-flex justify-content-sm-center justify-content-md-end">
                    <div class="ms-3 py-4 nav-link">
                            ...
                            <a href="{{ route('statusRoom', Auth::user()->id) }}"
                            class=' mx-2'><i class="bi bi-clipboard2-check-fill"></i> เช็คสถานะการจอง</a>
    ...
    <script src="{{asset('js/User/layout_user.js')}}"></script>
</body>
</html>
        {{-- <div class="col d-flex flex-row justify-content-end  align-items-center ">
