...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <select class="form-select" onchange="changStatus()" data-status="{{$items->booking->status_book}}" data-id="{{$items->booking_id}}"  {{$items->booking->status_book === 'ยกเลิกการจอง' || $items->booking->status_book === 'ยืนยันการจอง' ? 'disabled' : '' }}>
